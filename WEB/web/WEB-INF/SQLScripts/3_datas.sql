/* 
 * Base de données factice pour phase de test de la conception d'IHM
 */
/**
...
/*IMPRIMANTE*/
insert into imprimante3d (Nom,FablabNom,NbHeuresDeTravail,Etat,DureeRestante,CoutHoraire) values
    ("uprint1","FabLab_Victor_Hugo",1500,"TRAVAIL",22,800);
...
/*JOB*/
insert into job (UtilisateurCode,Imprimante3DNom, Nom, DateRealisation , Etat, DureeConsommee, ResteAFaireEstimee, SupportConsomme, MatiereConsommee, SupportEstime, MatiereEstimee, Prix) values
    ("45A7W4D73","uprint1","poignée","2019-01-17 22:00:00","FINI",18,0,40,12,0,0,14400);

insert into job (UtilisateurCode,Imprimante3DNom,  Nom, DateRealisation , Etat, DureeConsommee, ResteAFaireEstimee, SupportConsomme, MatiereConsommee, SupportEstime, MatiereEstimee, Prix) values
    ("SDQ5S7GFS98S","uprint1","cale","2019-01-17 10:00:00","FINI",5,0,15,12,0,0,720);

insert into job (UtilisateurCode,Imprimante3DNom, Nom, DateRealisation , Etat, DureeConsommee, ResteAFaireEstimee, SupportConsomme, MatiereConsommee, SupportEstime, MatiereEstimee, Prix) values
    ("45A7W4D73","uprint1","vis","2019-01-05","FINI",2,0,9,7,0,0,360);

insert into job (UtilisateurCode,Imprimante3DNom, Nom, DateRealisation , Etat, DureeConsommee, ResteAFaireEstimee, SupportConsomme, MatiereConsommee, SupportEstime, MatiereEstimee, Prix) values
    ("SDQ5S7GFS98S","uprint1","pieceqq","2019-01-17","FINI",3,0,10,9,0,0,450);

insert into job (UtilisateurCode,Imprimante3DNom, Nom, DateRealisation , Etat, DureeConsommee, ResteAFaireEstimee, SupportConsomme, MatiereConsommee, SupportEstime, MatiereEstimee, Prix) values
    ("SDQ5S7GFS98S","uprint1","support","2019-04-04","EN_COURS",3,0,10,9,0,0,450);
